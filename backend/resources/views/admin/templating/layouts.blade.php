...
<html lang="en">
    <head>
        ...
        <!-- Template CSS -->
        <link href="assets/css/dashboard.main.css?v=1.1" rel="stylesheet" type="text/css" />
    </head>
    ...
    <body>
        ...
        <aside class="navbar-aside" id="offcanvas_aside">
            <div class="aside-top">
                <a href="index.html" class="brand-wrap">
                    <img src="assets/imgs/theme/agrihub.svg" class="logo" alt="Nest Dashboard" />
                </a>
                <div>
        ...
        <script src="assets/js/vendor/jquery.fullscreen.min.js"></script>
        <script src="assets/js/vendor/chart.js"></script>
        <!-- Main Script -->
        <script src="assets/js/dashboard.main.js?v=1.1" type="text/javascript"></script>
